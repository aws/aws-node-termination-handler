...
import (
	nthAppConfig "github.com/aws/aws-node-termination-handler/pkg/config"
...
func InitDrainer(nthConfig nthAppConfig.Config) {
	if drainHelper == nil {
...
func Drain(nthConfig nthAppConfig.Config) {
...
func getDrainHelper(nthConfig nthAppConfig.Config) *drain.Helper {
	...
	return &drain.Helper{
		...
		Timeout:             time.Duration(nthConfig.DrainTimeBeforeTermination) * time.Second,
		Out:                 os.Stdout,
		ErrOut:              os.Stderr,
	}
}
